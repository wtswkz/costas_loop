...
for i = 1:steps
    ...
    % x_i(i) = d((i-1)*Dump_N+1:i*Dump_N) .* cos(phi_i((i-1)*Dump_N+1:i*Dump_N) - phi_lo((i-1)*Dump_N+1:i*Dump_N));
    % x_q(i) = d((i-1)*Dump_N+1:i*Dump_N) .* sin(phi_i((i-1)*Dump_N+1:i*Dump_N) - phi_lo((i-1)*Dump_N+1:i*Dump_N));
